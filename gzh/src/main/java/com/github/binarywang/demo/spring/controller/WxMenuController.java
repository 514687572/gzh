...
public class WxMenuController implements WxMpMenuService {
    ...
    public String menuCreateSample() throws WxErrorException {
        ...
        button1.setName("我的纪念日");
        button1.setKey("myDate");
        button1.setUrl(Constantutils.url);

        menu.getButtons().add(button1);
        WxMenuButton button2 = new WxMenuButton();
        button2.setType(WxConsts.BUTTON_VIEW);
        button2.setName("添加日期");
        button2.setKey("addDate");
        button2.setUrl(Constantutils.add_url);
        
        WxMenuButton button3 = new WxMenuButton();
        button3.setType(WxConsts.BUTTON_CLICK);
        button3.setName("时光机器");
        button3.setKey("timeDate");

        menu.getButtons().add(button2);

        WxMenuButton button31 = new WxMenuButton();
        button31.setType(WxConsts.BUTTON_VIEW);
        button31.setName("制作相册");
        button31.setUrl("http://weixinmap.com/index");

        WxMenuButton button32 = new WxMenuButton();
        button32.setType(WxConsts.BUTTON_VIEW);
        button32.setName("提醒设置");
        button32.setUrl("http://baidu.com");
